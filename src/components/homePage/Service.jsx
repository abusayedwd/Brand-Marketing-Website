...
//                 <p className="mb-6">
//                   Connect with top Content Creator to elevate your brand through 
  ...
  const services = [
    {
      title: "Content Idea Generation",
      image: "/images/service.png",
      description: "Collaborate with our expert creators to generate fresh and impactful content ideas."
    },
    {
      title: "Brand Campaigns",
      image: "/images/service_2.png",
      description: "Strategize and execute campaigns that resonate with your target audience, driving maximum engagement."
    },
    {
    ...
    },
    {
      ...
      image: "/images/service_3.png",
      description: "Optimize and analyze your content for maximum performance and impact."
    }
  ];
  ...
  return (
    <div className="bg-gray-50 py-16 overflow-hidden">
      <div className="md:container mx-auto px-4">
        {/* Brivio Overview */}
        <div 
          className={`text-blue-500 font-medium mb-3 transform transition-all duration-700 ${animated ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
        >
          What is Brivio?
        </div>
        <h2 
          className={`text-2xl font-bold mb-8 text-gray-900 transform transition-all duration-700 delay-100 ${animated ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
        >
          Brivio is a platform that connects businesses with top content creators. We help brands elevate their presence by generating authentic content and launching strategic promotional campaigns.
        </h2>
          ...
          >
            <div className="p-6 h-full flex flex-col justify-between">
              <div>
                <h3 className="text-2xl font-bold mb-4">Our Services</h3>
                <p className="mb-6">
                  Connect with top content creators to elevate your brand through authentic content and strategic promotional campaigns for maximum impact.
                </p>
              </div>
              <Button 
                type="link" 
