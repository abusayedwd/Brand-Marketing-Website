...
// import { useInfluencerChartQuery } from '@/redux/fetures/wallet/getEarnigChart';
...
//   const {data: areaChartData} = useInfluencerChartQuery(selectedYear)
...
const Barchart = () => {
  ...
  // Fetching the area chart data based on selected year
  const { data: areaChartData } = useInfluencerChartQuery(selectedYear);
  // console.log(areaChartData);
  ...
  return (
    <div className="flex flex-col p-6 bg-gray-50 font-sans">
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 md:w-2/3">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-semibold">Earning Chart</h2>
            <div className="flex items-center gap-4">
              <Select
                defaultValue={selectedYear}
                onChange={handleYearChange}
          ...
          <div className="h-64 relative">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart
                data={formattedAreaChartData} // Use formatted data here
                margin={{ top: 5, right: 20, bottom: 5, left: 0 }}
              >
                <defs>
                  <linearGradient id="colorBlueGradient" x1="0" y1="0" x2="0" y2="1">
